...
pub fn verify_authenticated_custom_data_result(
    ...
    let authenticated_res: AuthenticatedKVLookup = authenticated_res
        .into_serde()
        .c(d!())
        .map_err(error_to_jsvalue)?;
...
pub fn create_debt_policy_info(
    ...
    rs_create_debt_policy_info(ir_numerator, ir_denominator, fiat_code, loan_amount)
        .c(d!())
        .map_err(error_to_jsvalue)
}
...
pub fn create_debt_memo(
    ...
    rs_create_debt_memo(ir_numerator, ir_denominator, fiat_code, loan_amount)
        .c(d!())
        .map_err(error_to_jsvalue)
}
