...
pub extern "C" fn ffi_build_id() -> *mut c_char {
    string_to_c_char(rs_build_id())
}

#[no_mangle]
pub extern "C" fn ffi_random_asset_type() -> *mut c_char {
    string_to_c_char(rs_random_asset_type())
}
...
// TODO
#[no_mangle]
pub extern "C" fn ffi_authenticated_kv_lookup_new() -> *mut AuthenticatedKVLookup {
    unimplemented!()
...
#[no_mangle]
pub unsafe extern "C" fn ffi_authenticated_kv_lookup_destroy(
...
pub unsafe extern "C" fn ffi_verify_authenticated_custom_data_result(
    ...
    let state_commitment = c_char_to_string(state_commitment);
    rs_verify_authenticated_custom_data_result(
        state_commitment,
